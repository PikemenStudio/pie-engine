...
glm::mat4 Actor::calculateTransformation() {
  ...
  Result *= glm::rotate(Result, RotationAngles.x / 16, glm::vec3(1.0f, 0.0f, 0.0f));
  Result *= glm::rotate(Result, RotationAngles.y / 16, glm::vec3(0.0f, 1.0f, 0.0f));
  Result *= glm::rotate(Result, RotationAngles.z / 16, glm::vec3(0.0f, 0.0f, 1.0f));
